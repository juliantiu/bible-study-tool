        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BibleBookOrder = table.Column<int>(type: "integer", nullable: false),
                    BibleBookDefaultAbbreviation = table.Column<string>(type: "text", nullable: false),
                    BibleBookDefaultName = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BibleVersionId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    BibleVersionDefaultName = table.Column<string>(type: "text", nullable: false),
                    BibleVersionDefaultAbbreviation = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NoteSummary = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TagLabel = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BibleVersionId = table.Column<int>(type: "integer", nullable: false),
                    LanguageCode = table.Column<string>(type: "text", nullable: false),
                    BibleVersionName = table.Column<string>(type: "text", nullable: false),
                    BibleVersionAbbreviation = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
